...
class AngleCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // Degree default
    private var unit2Factor = 0.0174532925 // Radian default

    private val units = arrayOf(
        AngleUnit("Degree", "°", 1.0),
        AngleUnit("Radian", "rad", 57.2957795),
        AngleUnit("Gradian", "grad", 0.9),
        AngleUnit("Minute", "'", 1.0/60.0),
        AngleUnit("Second", "\"", 1.0/3600.0),
        AngleUnit("Circle", "circle", 360.0)
    )
    ...
    private fun showUnitPicker(onSelected: (AngleUnit) -> Unit) {
    ...
    data class AngleUnit(val name: String, val symbol: String, val factor: Double)
}
