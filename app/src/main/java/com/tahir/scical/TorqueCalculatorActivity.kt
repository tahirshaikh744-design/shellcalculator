...
class TorqueCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // Newton-meter default
    private var unit2Factor = 0.01 // Newton-centimeter default

    private val units = arrayOf(
        TorqueUnit("Newton-meter", "Nm", 1.0),
        TorqueUnit("Newton-centimeter", "Ncm", 0.01),
        TorqueUnit("Newton-millimeter", "Nmm", 0.001),
        TorqueUnit("Kilonewton-meter", "kNm", 1000.0),
        TorqueUnit("Dyne-meter", "dyn-m", 1e-5),
        TorqueUnit("Kilogram-force-meter", "kgf-m", 9.80665),
        TorqueUnit("Gram-force-centimeter", "gf-cm", 0.0000980665),
        TorqueUnit("Pound-force-foot", "lbf-ft", 1.355818),
        TorqueUnit("Pound-force-inch", "lbf-in", 0.1129848),
        TorqueUnit("Ounce-force-inch", "ozf-in", 0.00706155)
    )
    ...
    private fun showUnitPicker(onSelected: (TorqueUnit) -> Unit) {
    ...
    data class TorqueUnit(val name: String, val symbol: String, val factor: Double)
}
