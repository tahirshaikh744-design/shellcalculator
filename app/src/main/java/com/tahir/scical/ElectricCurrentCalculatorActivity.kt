...
class ElectricCurrentCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // Ampere default
    private var unit2Factor = 0.001 // Milliampere default

    private val units = arrayOf(
        CurrentUnit("Ampere", "A", 1.0),
        CurrentUnit("Milliampere", "mA", 0.001),
        CurrentUnit("Microampere", "µA", 1e-6),
        CurrentUnit("Kiloampere", "kA", 1000.0),
        CurrentUnit("Megaampere", "MA", 1e6),
        CurrentUnit("Gigaampere", "GA", 1e9),
        CurrentUnit("Abampere", "abA", 10.0),
        CurrentUnit("Statampere", "statA", 3.335641e-10)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvHeaderTitle.text = "Electric Current"
    ...
    private fun showUnitPicker(onSelected: (CurrentUnit) -> Unit) {
    ...
    data class CurrentUnit(val name: String, val symbol: String, val factor: Double)
}
