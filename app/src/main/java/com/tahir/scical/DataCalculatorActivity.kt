...
class DataCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1048576.0 // MB default
    private var unit2Factor = 1024.0 // KB default

    private val units = arrayOf(
        DataUnit("Bit", "b", 0.125),
        DataUnit("Byte", "B", 1.0),
        DataUnit("Kilobyte", "KB", 1024.0),
        DataUnit("Megabyte", "MB", 1048576.0),
        DataUnit("Gigabyte", "GB", 1073741824.0),
        DataUnit("Terabyte", "TB", 1099511627776.0),
        DataUnit("Petabyte", "PB", 1125899906842624.0)
    )
    ...
    private fun showUnitPicker(onSelected: (DataUnit) -> Unit) {
    ...
    data class DataUnit(val name: String, val symbol: String, val factor: Double)
}
