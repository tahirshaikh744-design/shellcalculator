...
class VolumeFlowCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // Cubic meter per second default
    private var unit2Factor = 0.001 // Liter per second default

    private val units = arrayOf(
        FlowUnit("Cubic meter/second", "m³/s", 1.0),
        FlowUnit("Cubic meter/hour", "m³/h", 1.0/3600.0),
        FlowUnit("Cubic meter/minute", "m³/min", 1.0/60.0),
        FlowUnit("Liter/second", "L/s", 0.001),
        FlowUnit("Liter/minute", "L/min", 0.001/60.0),
        FlowUnit("Liter/hour", "L/h", 0.001/3600.0),
        FlowUnit("Cubic foot/second", "ft³/s", 0.0283168466),
        FlowUnit("Cubic foot/minute", "ft³/min", 0.0283168466/60.0),
        FlowUnit("Gallon/minute (US)", "gpm", 0.00378541/60.0),
        FlowUnit("Barrel/day (US)", "bpd", 0.158987/86400.0)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvHeaderTitle.text = "Volume Flow"
        ...
        tvUnit2Name.text = units[3].name
        tvUnit2Symbol.text = units[3].symbol
        unit2Factor = units[3].factor
    ...
    private fun showUnitPicker(onSelected: (FlowUnit) -> Unit) {
    ...
    data class FlowUnit(val name: String, val symbol: String, val factor: Double)
}
