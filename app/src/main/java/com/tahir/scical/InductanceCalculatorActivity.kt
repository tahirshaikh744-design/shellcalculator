...
class InductanceCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // Henry
    private var unit2Factor = 1e-3 // Millihenry

    private val units = arrayOf(
        InductanceUnit("Henry", "H", 1.0),
        InductanceUnit("Millihenry", "mH", 1e-3),
        InductanceUnit("Microhenry", "µH", 1e-6),
        InductanceUnit("Nanohenry", "nH", 1e-9),
        InductanceUnit("Picohenry", "pH", 1e-12),
        InductanceUnit("Abhenry", "abH", 1e-9),
        InductanceUnit("Stathenry", "statH", 8.987552e11)
    )
    ...
    private fun showUnitPicker(onSelected: (InductanceUnit) -> Unit) {
    ...
    data class InductanceUnit(val name: String, val symbol: String, val factor: Double)
}
