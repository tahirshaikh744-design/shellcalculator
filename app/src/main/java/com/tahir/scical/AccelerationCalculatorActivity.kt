...
class AccelerationCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit2Factor = 9.80665 // g-unit default

    private val units = arrayOf(
        AccUnit("Meter/second²", "m/s²", 1.0),
        AccUnit("Foot/second²", "ft/s²", 0.3048),
        AccUnit("G-unit", "g", 9.80665),
        AccUnit("Galileo", "Gal", 0.01),
        AccUnit("Inch/second²", "in/s²", 0.0254)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvHeaderTitle.text = "Acceleration"
    ...
    private fun showUnitPicker(onSelected: (AccUnit) -> Unit) {
    ...
    data class AccUnit(val name: String, val symbol: String, val factor: Double)
}
