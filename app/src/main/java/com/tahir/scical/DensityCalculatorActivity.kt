...
class DensityCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // kg/m³
    private var unit2Factor = 1000.0 // g/cm³

    private val units = arrayOf(
        DensityUnit("Kilogram/cubic meter", "kg/m³", 1.0),
        DensityUnit("Gram/cubic centimeter", "g/cm³", 1000.0),
        DensityUnit("Gram/cubic millimeter", "g/mm³", 1e6),
        DensityUnit("Milligram/cubic meter", "mg/m³", 1e-6),
        DensityUnit("Pound/cubic foot", "lb/ft³", 16.018463),
        DensityUnit("Pound/cubic inch", "lb/in³", 27679.904),
        DensityUnit("Ounce/cubic inch", "oz/in³", 1729.994)
    )
    ...
    private fun showUnitPicker(onSelected: (DensityUnit) -> Unit) {
    ...
    data class DensityUnit(val name: String, val symbol: String, val factor: Double)
}
