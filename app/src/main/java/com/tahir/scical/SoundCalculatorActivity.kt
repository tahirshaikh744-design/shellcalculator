...
class SoundCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // Bel default
    private var unit2Factor = 0.1 // Decibel default

    private val units = arrayOf(
        SoundUnit("Bel", "B", 1.0),
        SoundUnit("Decibel", "dB", 0.1),
        SoundUnit("Neper", "Np", 0.8685889638)
    )
    ...
    private fun showUnitPicker(onSelected: (SoundUnit) -> Unit) {
    ...
    data class SoundUnit(val name: String, val symbol: String, val factor: Double)
}
