...
class IlluminanceCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // lux
    private var unit2Factor = 10.76391 // foot-candle

    private val units = arrayOf(
        IlluminanceUnit("Lux", "lx", 1.0),
        IlluminanceUnit("Foot-candle", "fc", 10.76391),
        IlluminanceUnit("Phot", "ph", 10000.0),
        IlluminanceUnit("Nox", "nx", 0.001)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvHeaderTitle.text = "Illuminance"
    ...
    private fun showUnitPicker(onSelected: (IlluminanceUnit) -> Unit) {
    ...
    data class IlluminanceUnit(val name: String, val symbol: String, val factor: Double)
}
