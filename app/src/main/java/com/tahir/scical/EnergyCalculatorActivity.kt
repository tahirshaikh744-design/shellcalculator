...
class EnergyCalculatorActivity : BaseCalculatorActivity() {
    ...
    private var unit1Factor = 1.0 // Joule default
    private var unit2Factor = 4.184 // Calorie default
    ...
    private val units = arrayOf(
        ...
        EnergyUnit("British thermal unit", "BTU", 1055.06),
        EnergyUnit("Electronvolt", "eV", 1.60218e-19)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvUnit1Value.setOnClickListener { activeField(1) }
        ...
        tvUnit2Value.setOnClickListener { activeField(2) }
    ...
    private fun showUnitPicker(onSelected: (EnergyUnit) -> Unit) {
    ...
    data class EnergyUnit(val name: String, val symbol: String, val factor: Double)
}
